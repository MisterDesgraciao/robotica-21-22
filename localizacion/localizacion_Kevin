...
def localizacion(balizas, real, ideal, centro, radio, mostrar=0):
  ...
  # Se recorre el radio (puesto a 0.5) en 0.1 (x,y) para buscar una nueva posición 
  # cuyo margen de error sea el mínimo 
  # Una vez encontrado, es el que se guarda como posición ideal.
...
EPSILON = .12            # Umbral de distancia
...
for punto in objetivos:
  while distancia(tray_ideal[-1],punto) > EPSILON and len(tray_ideal) <= 1000:
    ...
    #
    # Después de realizar el desplazamiento, se calcula cuánto difiere
    # la posición real con la ideal. Si es mayor que la precisión, se llama
    # a localización para corregir
    #
