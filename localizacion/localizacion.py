...
def localizacion(balizas, real, ideal, centro, radio, mostrar=0):
  ...
  for i in np.arange(): # nos da un range decimal
    for j in np.arange():
      error = ideal.measurement_prob #
      #nos quedamos con el error más pequeño
      #nos quedamos con el cuadrado del error más pequeño
